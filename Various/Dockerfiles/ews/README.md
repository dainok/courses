...
```
docker run --name workstation --rm -d -p 443:6901 --shm-size=512m -e VNC_PW=password dainok/ews:latest
```
...
```
docker run --name workstation --rm -d -p 443:6901 --shm-size=512m -v /tmp:/home/kasm-user/Downloads -e VNC_PW=password dainok/ews:latest
```
